...
import static com.example.ailatrieuphu.Other.GlobalVariables.COUNT_TIME;
import static com.example.ailatrieuphu.Other.GlobalVariables.GIA_DIEM;
import static com.example.ailatrieuphu.Other.GlobalVariables.KEY_CH_POSITION;
import static com.example.ailatrieuphu.Other.GlobalVariables.TIME_CHUYEN_CAU_HOI;
import static com.example.ailatrieuphu.Other.GlobalVariables.TOTAL_TIME_TIMER;
...
public class HienThiCauHoiFragment extends Fragment {
    ...
    public HienThiCauHoiFragment(List<CauHoi> cauHois, Context context, CauHoiAdapter adapter) {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            ViewGroup rootView = (ViewGroup) inflater.inflate(
                    R.layout.fragment_hien_thi_cau_hoi, container, false);
            radiation(rootView);
            return rootView;
    ...
    private void radiation(View v) {
        tvCauHoiSo = v.findViewById(R.id.textViewSoCauHoi);
        tvCauHoi = v.findViewById(R.id.text_question);

        tvTimer = v.findViewById(R.id.textCountTime);


        btnPhuongAn = new Button[4];
        btnPhuongAn[0] = v.findViewById(R.id.btn_DapAn_A);
        btnPhuongAn[1] = v.findViewById(R.id.btn_DapAn_B);
        btnPhuongAn[2] = v.findViewById(R.id.btn_DapAn_C);
        btnPhuongAn[3] = v.findViewById(R.id.btn_DapAn_D);

        //tham chiếu file include
        //ánh xạ các ID trong đó
        ivbtnSP = new ImageButton[4];
        ivbtnSP[0] = v.findViewById(R.id.imageButtonGoiDienNguoiThan);
        ivbtnSP[1] = v.findViewById(R.id.imageButtonKhanGiaTroGiup);
        ivbtnSP[2] = v.findViewById(R.id.imageButton50percent);
        ivbtnSP[3] = v.findViewById(R.id.imageButtonDoiCauHoi);
    }
